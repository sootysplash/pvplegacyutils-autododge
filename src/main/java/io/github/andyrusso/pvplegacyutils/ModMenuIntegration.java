...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            menu.getOrCreateCategory(Text.translatable("pvplegacyutils.autoDodge"))
                    .addEntry(
                            toggleOption(
                                    "pvplegacyutils.dodge",
                                    config.autoDodge,
                                    value -> config.autoDodge = value
                            ))
                    .addEntry(
                            toggleOption(
                                    "pvplegacyutils.dodge.teams",
                                    config.autoDodgeTeams,
                                    value -> config.autoDodgeTeams = value
                            ))
                            .addEntry(
                                    strField(
                            "pvplegacyutils.autododge.player",
                            config.autoDodgePlayer,
                            (string) -> config.autoDodgePlayer = string,
                            "Nominous")
